...
**License:** `Mozilla Public License 2.0 <https://github.com/61418/boto3-refresh-session/blob/main/LICENSE>`_
...
It automatically refreshes temporary AWS credentials, caches clients and resources, and natively supports MFA providers. 
...
More, the available alternatives to boto3-refresh-session do not support the breadth of features that boto3-refresh-session does, such as client/resource caching, MFA providers, or IoT Core X.509 credential refresh, among others.
Even if you don't need automatic temporary AWS credential refresh, boto3-refresh-session's caching feature may still be useful to you.
